...
if($sub[0]=='add')
{
      ...
      include($cat."/".implode('-',$val).".php");   
        ...
        <div class="row">
                ...
                <div class="col-4">
                       <div class="product"> 
                  <img width="250px" height="250px" src="./<?php echo $result['image']?>">
                  <h4><?php echo $result['name']. " ". $result['model']?></h4>
                  <p>Top speed: <?php echo $result['topspeed']?></p>
                  <p>BDT <?php echo $result['price']?></p>
