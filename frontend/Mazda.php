                ...
                <div class="row">
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="m1.webp" width="200" height="175">
                                    <div class="card-body text-center">
                                        <br>
                                        <h5 class="card-title">2020 Mazda CX-5 Grand Touring</h5>
                                        <p class="card-text">Price: 260,905 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2020 Mazda CX-5 Grand Touring">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="m2.webp" width="200" height="200">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2019 Mazda CX-9 Grand Touring</h5>
                                        <p class="card-text">Price: 350,500 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2019 Mazda CX-9 Grand Touring">
                                        <input type="hidden" name="Price" value="350500">
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="m3.webp" width="200" height="200">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2021 Mazda CX-5 Grand Touring</h5>
                                        <p class="card-text">Price: 350,000 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2021 Mazda CX-5 Grand Touring">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="m4.webp" width="200" height="200">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2016 Mazda CX-5 Touring</h5>
                                        <p class="card-text">Price: 180,500 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2016 Mazda CX-5 Touring">
                                        <input type="hidden" name="Price" value="180500">
                                    </div>
                                </div>
                            </form>
