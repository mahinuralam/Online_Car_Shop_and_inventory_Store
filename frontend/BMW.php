                ...
                <div class="row">
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="b1.jpeg" width="200" height="220">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2018 BMW 330 i xDrive</h5>
                                        <br>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="b2.jpg" width="200" height="220">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2021 BMW X5 M50i</h5>
                                        <br>
                                        <p class="card-text">Price: 850,473 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2021 BMW X5 M50i">
                                        <input type="hidden" name="Price" value="850473">
                                    </div>
                                </div>
                            </form>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                         <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="b3.jpg" width="200" height="197">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2017 BMW X5 xDrive35i</h5>
                                        <br>
                                        <p class="card-text">Price: 410,599 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2017 BMW X5 xDrive35i">
                                        <input type="hidden" name="Price" value="410599">
                                    </div>
                                </div>
                            </form>
