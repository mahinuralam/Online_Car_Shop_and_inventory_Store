                ...
                <div class="row">
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="f1.webp" width="200" height="220">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2014 Ferrari FF Base</h5>
                                        <p class="card-text">Price: 169,999 BDT</p>
                                        <br>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2014 Ferrari FF Base">
                                        <input type="hidden" name="Price" value="169999">
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="f2.webp" width="200" height="220">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2021 Ferrari SF90 Stradale Base</h5>
                                        <p class="card-text">Price: 849,900 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2021 Ferrari SF90 Stradale Base">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="f3.webp" width="200" height="244">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2017 Ferrari 488 Spider Base</h5>
                                        <p class="card-text">Price: 374,900 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2017 Ferrari 488 Spider Base">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <form action="m1.php" method="POST">
                                <div class="card">
                                    <img class="card-img-top" src="f4.webp" width="200" height="244">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">2013 Ferrari 458 Italia Base</h5>
                                        <p class="card-text">Price: 229,995 BDT</p>
                                        <button type="submit" name="Add_Cart" class="btn btn-primary">View Details</button>
                                        <input type="hidden" name="Item_Name" value="2013 Ferrari 458 Italia Base">
