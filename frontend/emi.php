            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <br>
                        <form id="emi-form" action="connect_emi.php" method="POST" oninput="x.value = ( ( parseInt(b.value) - ( parseInt(b.value) * 30 / 100 ) ) + ( ( parseInt(b.value) - ( parseInt(b.value) * 30 / 100 ) ) * 10 / 100 ) ) / parseInt(a.value)">
                            ...
                            <h5>Month  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Price
                            &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Every month installment
                            </h5>
                            <input type="number" id="a" value=""> &nbsp <input type="number" id="b" value="">
                            &nbsp = &nbsp <output id="emi-value" name="x" for="a b"> </output> <b> BDT </b>
                            ...
                            <div>
                                <input class="btn btn-info" type="submit" value="Confirm EMI Request">
                            </div>
        ...
        <div class="container">
            <center>
                <b>
                    ...
                    <p>This website is developed by &copyMahinur Alam</p>
